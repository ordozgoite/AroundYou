...
enum AYEndpoints {
    ...
    case postNewCommunity(name: String, imageUrl: String?, latitude: Double, longitude: Double, token: String)
...
extension AYEndpoints: Endpoint {
    ...
    var body: [String : Any]? {
        ...
        case .updateUserPreferences(let gender, let interestGenders, let age, let minInterestAge, let maxInterestAge, let isNotificationsEnabled, _):
            ...
            return params
        case .postNewCommunity(let name, let imageUrl, let latitude, let longitude, _):
            var  params: [String: Any] = [
                "name": name,
                "latitude": latitude,
                "longitude": longitude
