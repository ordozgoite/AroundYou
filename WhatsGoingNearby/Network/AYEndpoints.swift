...
extension AYEndpoints: Endpoint {
    ...
    var body: [String : Any]? {
        ...
        case .postNewChat(let otherUserUid, _):
            ...
            return params
        case .postNewMessage(let chatId, let text, let repliedMessageId, _):
            var params: [String: Any] = [
                "chatId": chatId,
                "text": text
            ]
